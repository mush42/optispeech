...
def clean_text(text, language, version=None):
    ...
    language_module = __import__("optispeech.text2."+language_module_map[language],fromlist=[language_module_map[language]])
...
def text_to_sequence(text, language, version=None):
    ...
    from optispeech.text2 import cleaned_text_to_sequence
