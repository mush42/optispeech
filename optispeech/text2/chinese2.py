...
from optispeech.text2.symbols import punctuation
from optispeech.text2.tone_sandhi import ToneSandhi
from optispeech.text2.zh_normalization.text_normlization import TextNormalizer
...
if is_g2pw:
    ...
    from optispeech.text2.g2pw import G2PWPinyin, correct_pronunciation
    parent_directory = os.path.dirname(current_file_path)
    g2pw = G2PWPinyin(model_dir="optispeech/text2/G2PWModel",
                      model_source=os.environ.get("bert_path","optispeech/text2/chinese-roberta-wwm-ext-large"),
                      v_to_u=False, 
