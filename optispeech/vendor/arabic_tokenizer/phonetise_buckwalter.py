...
def preprocess_utterance(utterance):
    ...
    utterance = re.sub(r'Ai', u'<i', utterance)
    utterance = re.sub(r'Aa', u'>a', utterance)
    utterance = re.sub(r'Au', u'>u', utterance)
    utterance = re.sub(r'^>([^auAw])', u'>a\\1', utterance)
    utterance = re.sub(r' >([^auAw ])', u' >a\\1', utterance)
    utterance = re.sub(r'<([^i])', u'<i\\1', utterance)
